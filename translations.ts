...
export const translations: Translations = {
  ...
  welcomeSub: { 
    ...
    ja: '랜드마크에 숨겨진 이야기나 지역의 비밀을 발견해보세요.',
    zh: '发现地标背后隐藏的故事和当地秘密।',
  ...
  clearHistory: { en: 'Clear History', ko: '기록 삭제', ja: '履歴をクリア', zh: '清除历史', es: 'Borrar historial', fr: 'Effacer l\'historique', de: 'Verlauf 로드...', it: 'Cancella cronologia' },
  ...
  contactDev: { en: 'Contact Developer', ko: '개발자 연락하기', ja: '開発者に連絡', zh: '联系开发者', es: 'Contactar desarrollador', fr: 'Contacter le dév', de: 'Entwickler kontaktieren', it: 'Codice promo' },
  ...
  resumeGuide: { en: 'Resume Guide', ko: '가이드 이어보기', ja: 'ガイド를 再開', zh: '继续指南', es: 'Continuar guía', fr: 'Reprendre le guide', de: 'Leitfaden fortsetzen', it: 'Riprendi guida' },
  ...
  exploring: { en: 'Exploring...', ko: '탐색 중...', ja: '探索중...', zh: '探索中...', es: 'Explorando...', fr: 'Exploring...', de: 'Erkunden...', it: 'Esplorando...' },
